...
def animate(j):
    ...
    ### force ###
    plots_ee_twist.set_data(time[idx_start:idx]-time[idx_start], EE_twist[idx_start:idx,2])
    plots_ee_twist_d.set_data(time[idx_start:idx]-time[idx_start], EE_twist_d[idx_start:idx,2])
...
plots_ee_twist, = sub1.plot(time[init:idx_start]-time[idx_start], FT_ati[init:idx_start, 2],linewidth=lw)
